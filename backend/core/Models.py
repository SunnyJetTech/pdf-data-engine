...
class UploadedFile(Base):
    ...
    mongo_collection = Column(String(255))
    created_at = Column(DateTime, default=datetime.utcnow)
    
    user = relationship("User", back_populates="uploads")
    columns = relationship("ColumnMetadata", back_populates="file")
...
class Document(Base):
    ...
    mongo_collection = Column(String(255), nullable=False, unique=True)
